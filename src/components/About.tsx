      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="order-2 md:order-1">
            <h3 className="text-2xl font-bold text-pink-dark mb-4">Привет, я Ирина!</h3>
            <p className="text-foreground mb-4">
              Мне 15 лет, и я учусь в школе №42. Я люблю искусство, музыку и проводить время с друзьями. 
              В свободное время я занимаюсь рисованием, играю на фортепиано и изучаю английский язык.
            </p>
            <p className="text-foreground mb-6">
              Мечтаю стать фотографом и путешествовать по всему миру. 
              Считаю, что главное в жизни — это найти своё призвание и не бояться следовать за мечтой!
            </p>
            ...
            <div className="grid grid-cols-2 gap-4">
              <Card className="hover-scale bg-pink-light border-none">
                <CardContent className="flex flex-col items-center p-4">
                  ...
                  <h4 className="font-semibold text-foreground">Фотография</h4>
                </CardContent>
              </Card>
              ...
              <Card className="hover-scale bg-mint-light border-none">
                <CardContent className="flex flex-col items-center p-4">
                  ...
                  <h4 className="font-semibold text-foreground">Английский</h4>
                </CardContent>
              </Card>
              ...
              <Card className="hover-scale bg-pink-light border-none">
                <CardContent className="flex flex-col items-center p-4">
                  <div className="w-10 h-10 rounded-full bg-pink flex items-center justify-center mb-2">
                    <Icon name="PenTool" className="text-white" />
                  </div>
                  <h4 className="font-semibold text-foreground">Рисование</h4>
                </CardContent>
              </Card>
            </div>
          </div>
